...
In the rest of the article, you can just replace `C:\` with `dotnet`. Everything else is the same. Based on our tests, no sudo access is needed to run the license server on Linux.
